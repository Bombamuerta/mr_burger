...
function init() {
    ...
    var placemark = new ymaps.Placemark([59.96, 30.32], {
    ...
    var placemark2 = new ymaps.Placemark([59.93, 30.26], {
    ...
    var placemark3 = new ymaps.Placemark([59.92, 30.48], {
        hintContent: '<div class="hint">ул.Колобкова, д.20</div>',
        balloonContent: '<div class="map-balloon">Я же колобок в конце концов!</div>',
    }, 
    {
        iconLayout: 'default#image',
        iconImageHref: '/img/map-marker.svg',
